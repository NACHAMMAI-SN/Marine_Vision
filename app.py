...
class DummyPredictor:
    def __init__(self):
        self.model_performance = {
            'cnn': {'accuracy': 92, 'name': 'CNN', 'icon': 'fas fa-brain'},
            'svm': {'accuracy': 87, 'name': 'SVM', 'icon': 'fas fa-project-diagram'},
            'random_forest': {'accuracy': 75, 'name': 'Random Forest', 'icon': 'fas fa-tree'},
            'knn': {'accuracy': 72, 'name': 'KNN', 'icon': 'fas fa-sitemap'},
            'kmeans': {'accuracy': 0, 'name': 'K-means', 'icon': 'fas fa-object-group'}
        }
